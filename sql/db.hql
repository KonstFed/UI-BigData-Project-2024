...
CREATE EXTERNAL TABLE anime STORED AS AVRO LOCATION '/user/team20/project/warehouse/anime'
TBLPROPERTIES ('avro.schema.url'='/user/team20/project/warehouse/avsc/anime.avsc');

CREATE EXTERNAL TABLE users_details STORED AS AVRO LOCATION '/user/team20/project/warehouse/users_details'
TBLPROPERTIES ('avro.schema.url'='/user/team20/project/warehouse/avsc/users_details.avsc');

CREATE EXTERNAL TABLE users_scores STORED AS AVRO LOCATION '/user/team20/project/warehouse/users_scores'
